...
export DESIGN_NAME='sram_wrap';
export EXTRA_LIBS='./designs/SRAMGenerator/macros/sky130_sram_2kbyte_1rw1r_32x512_8_TT_1p8V_25C.lib';
...
export SAVE_NETLIST='./results/synthesis/sram_wrap.v';
export SYNTH_ADDER_TYPE='YOSYS';
export SYNTH_BUFFERING='1';
export SYNTH_CAP_LOAD='40.0';
...
export VERILOG_FILES='./designs/SRAMGenerator/src/sramgen.sv';
export VERILOG_FILES_BLACKBOX='./designs/SRAMGenerator/macros/sky130_sram_2kbyte_1rw1r_32x512_8.v';
