# Saved State
set ::env(ANTENNA_CHECK_CURRENT_DEF) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/signoff/36-core.p.def"
set ::env(ANTENNA_VIOLATOR_LIST) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/reports/signoff/41-antenna_violators.rpt"
...
set ::env(CORE_AREA) "5.52 10.88 244.26 288.32"
...
set ::env(CTS_CURRENT_DEF) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/placement/core.def"
...
set ::env(CURRENT_DEF) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/signoff/36-core.p.def"
set ::env(CURRENT_DIR) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/routing"
set ::env(CURRENT_GDS) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/signoff/core.gds"
set ::env(CURRENT_GUIDE) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/routing/19-global.guide"
set ::env(CURRENT_INDEX) "42"
set ::env(CURRENT_LIB) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/routing/mca/process_corner_nom/core.lib"
set ::env(CURRENT_NETLIST) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/signoff/36-core.nl.v"
set ::env(CURRENT_ODB) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/routing/core.odb"
set ::env(CURRENT_POWERED_NETLIST) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/signoff/36-core.pnl.v"
set ::env(CURRENT_SDC) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/17-core.sdc"
set ::env(CURRENT_SDF) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/routing/mca/process_corner_nom/core.sdf"
set ::env(CURRENT_SPEF) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/routing/mca/process_corner_nom/core.spef"
...
set ::env(DIE_AREA) "0.0 0.0 250.0 300.0"
...
set ::env(DRC_CURRENT_DEF) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/signoff/36-core.p.def"
...
set ::env(EXT_NETLIST) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/signoff/core.spice"
...
set ::env(GLB_CFG_FILE) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/config.tcl"
...
set ::env(LAST_TIMING_REPORT_TAG) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/reports/signoff/31-rcx_sta"
set ::env(LEC_ENABLE) "0"
set ::env(LEFT_MARGIN_MULT) "12"
set ::env(LIB_CTS) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/cts/cts.lib"
...
set ::env(LIB_SYNTH) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/synthesis/trimmed.lib"
set ::env(LIB_SYNTH_COMPLETE) "/root/.volare/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib"
set ::env(LIB_SYNTH_COMPLETE_NO_PG) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/synthesis/1-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib"
set ::env(LIB_SYNTH_MERGED) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/synthesis/merged.lib"
set ::env(LIB_SYNTH_NO_PG) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/synthesis/1-trimmed.no_pg.lib"
set ::env(LIB_TYPICAL) "/root/.volare/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib"
set ::env(LOGS_DIR) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/logs"
set ::env(LVS_CONNECT_BY_LABEL) "0"
set ::env(LVS_CURRENT_DEF) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/routing/core.def"
...
set ::env(MAGIC_GDS) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/signoff/core.magic.gds"
...
set ::env(MC_SDF_DIR) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/routing/mca/sdf"
set ::env(MC_SPEF_DIR) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/routing/mca/spef"
set ::env(MERGED_LEF) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/merged.nom.lef"
set ::env(MERGED_LEF_MAX) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/merged.max.lef"
set ::env(MERGED_LEF_MIN) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/merged.min.lef"
...
set ::env(OPENLANE_VERSION) "e545bc4cefa75523c7cc7145ecae9bf3269a7f06"
set ::env(PARSITICS_CURRENT_DEF) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/routing/core.def"
set ::env(PDK) "sky130A"
set ::env(PDKPATH) "/root/.volare/sky130A"
set ::env(PLACEMENT_CURRENT_DEF) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/floorplan/core.def"
...
set ::env(RCX_SDC_FILE) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/17-core.sdc"
set ::env(REPORTS_DIR) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/reports"
set ::env(RESULTS_DIR) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results"
...
set ::env(ROUTING_CURRENT_DEF) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/cts/14-core.resized.def"
set ::env(RSZ_DONT_TOUCH_RX) "\$^"
set ::env(RSZ_LIB) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/synthesis/resizer_sky130_fd_sc_hd__tt_025C_1v80.lib"
set ::env(RSZ_USE_OLD_REMOVER) "0"
set ::env(RT_MAX_LAYER) "met5"
set ::env(RT_MIN_LAYER) "met1"
set ::env(RUN_CTS) "1"
set ::env(RUN_CVC) "1"
set ::env(RUN_DIR) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33"
set ::env(RUN_DRT) "1"
...
set ::env(TMP_DIR) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp"
set ::env(TOP_MARGIN_MULT) "4"
set ::env(TRACKS_INFO_FILE) "/root/.volare/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tracks.info"
set ::env(TRACKS_INFO_FILE_PROCESSED) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/routing/config.tracks"
...
set ::env(_tmp_drt_file_prefix) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/routing/drt"
set ::env(_tmp_drt_rpt_prefix) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/reports/routing/drt"
set ::env(cts_logs) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/logs/cts"
set ::env(cts_reports) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/reports/cts"
set ::env(cts_results) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/cts"
set ::env(cts_tmpfiles) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/cts"
set ::env(drc_prefix) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/reports/signoff/drc"
set ::env(floorplan_logs) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/logs/floorplan"
set ::env(floorplan_reports) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/reports/floorplan"
set ::env(floorplan_results) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/floorplan"
set ::env(floorplan_tmpfiles) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/floorplan"
set ::env(fp_report_prefix) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/reports/floorplan/3-initial_fp"
set ::env(placement_logs) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/logs/placement"
set ::env(placement_reports) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/reports/placement"
set ::env(placement_results) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/placement"
set ::env(placement_tmpfiles) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/placement"
set ::env(routing_logs) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/logs/routing"
set ::env(routing_reports) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/reports/routing"
set ::env(routing_results) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/routing"
set ::env(routing_tmpfiles) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/routing"
set ::env(signoff_logs) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/logs/signoff"
set ::env(signoff_reports) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/reports/signoff"
set ::env(signoff_results) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/signoff"
set ::env(signoff_tmpfiles) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/signoff"
set ::env(synth_report_prefix) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/reports/synthesis/1-synthesis"
set ::env(synthesis_logs) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/logs/synthesis"
set ::env(synthesis_reports) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/reports/synthesis"
set ::env(synthesis_results) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/results/synthesis"
set ::env(synthesis_tmpfiles) "/openlane/designs/sv_core/runs/RUN_2023.05.14_22.42.33/tmp/synthesis"
set ::env(timer_end) "1684104689"
set ::env(timer_routed) "1684104577"
set ::env(timer_start) "1684104153"
