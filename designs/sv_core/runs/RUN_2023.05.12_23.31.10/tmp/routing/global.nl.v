module core (clk_i,
 ...
 sky130_fd_sc_hd__or2b_1 _2356_ (.A(\i_exec_stage.data_fwd_o[35] ),
    ...
    .X(_0310_));
 sky130_fd_sc_hd__nand4_4 _2357_ (.A(_0307_),
    .B(_0308_),
    .C(_0309_),
    .D(_0310_),
    .Y(_0311_));
 ...
 sky130_fd_sc_hd__a21bo_1 _2389_ (.A1(_2333_),
    ...
    .B1_N(_0341_),
    .X(_0342_));
 sky130_fd_sc_hd__buf_8 _2390_ (.A(_0342_),
    .X(_0343_));
 ...
 sky130_fd_sc_hd__clkbuf_4 _2465_ (.A(_0414_),
    .X(_0415_));
 sky130_fd_sc_hd__and3_4 _2466_ (.A(\i_decode_stage.decode_state_o[236] ),
 ...
 sky130_fd_sc_hd__o21a_2 _2499_ (.A1(_0384_),
    ...
    .B1(_0446_),
    .X(_0447_));
 sky130_fd_sc_hd__clkbuf_16 _2500_ (.A(_0447_),
    .X(_0448_));
 ...
 sky130_fd_sc_hd__buf_12 _2503_ (.A(_0450_),
    .X(_0451_));
 sky130_fd_sc_hd__buf_6 _2504_ (.A(_0328_),
    .X(_0452_));
 ...
 sky130_fd_sc_hd__mux2_2 _2506_ (.A0(\i_mem_slice_stage.mem_state_o[62] ),
    ...
    .S(_0453_),
    .X(_0454_));
 sky130_fd_sc_hd__buf_6 _2507_ (.A(_0330_),
    .X(_0455_));
 ...
 sky130_fd_sc_hd__a22o_1 _2545_ (.A1(\i_mem_slice_stage.mem_state_o[90] ),
    ...
    .B2(_0455_),
    .X(net252));
 sky130_fd_sc_hd__mux2_2 _2546_ (.A0(net252),
 ...
 sky130_fd_sc_hd__or2b_1 _2593_ (.A(_0346_),
    ...
    .X(_0531_));
 sky130_fd_sc_hd__a2bb2o_4 _2594_ (.A1_N(_0451_),
    .A2_N(_0530_),
    .B1(_0462_),
    .B2(_0531_),
    .X(_0532_));
 ...
 sky130_fd_sc_hd__mux2_1 _2608_ (.A0(\i_decode_stage.decode_state_o[100] ),
    ...
    .S(_0347_),
    .X(_0544_));
 sky130_fd_sc_hd__buf_4 _2609_ (.A(_0544_),
    .X(_0545_));
 ...
 sky130_fd_sc_hd__o21ai_4 _2659_ (.A1(_0384_),
    ...
    .B1(_0580_),
    .Y(_0589_));
 sky130_fd_sc_hd__clkbuf_16 _2660_ (.A(_0589_),
    .X(_0590_));
 ...
 sky130_fd_sc_hd__o21ai_4 _2815_ (.A1(\i_exec_stage.data_fwd_o[30] ),
    ...
    .B1(_0729_),
    .Y(_0730_));
 sky130_fd_sc_hd__buf_6 _2816_ (.A(_0339_),
    .X(_0731_));
 ...
 sky130_fd_sc_hd__or2_1 _3128_ (.A(_0582_),
    .B(_0712_),
    .X(_1040_));
 sky130_fd_sc_hd__buf_4 _3129_ (.A(_1040_),
    .X(_1041_));
 ...
 sky130_fd_sc_hd__mux2_1 _3217_ (.A0(_1051_),
    ...
    .S(_0540_),
    .X(_1123_));
 sky130_fd_sc_hd__inv_1 _3218_ (.A(_1123_),
    .Y(_1124_));
 ...
 sky130_fd_sc_hd__a31o_4 _3299_ (.A1(_1156_),
    ...
    .B1(_1203_),
    .X(net155));
 sky130_fd_sc_hd__nor2_4 _3300_ (.A(_0448_),
    .B(_0712_),
    .Y(_1204_));
 ...
 sky130_fd_sc_hd__and2b_1 _3962_ (.A_N(\i_exec_stage.exec_state_o[1] ),
    ...
    .X(_1812_));
 sky130_fd_sc_hd__clkbuf_4 _3963_ (.A(_1812_),
    .X(_1813_));
 ...
 sky130_fd_sc_hd__dfrtp_2 _4861_ (.CLK(clknet_leaf_27_clk_i),
    .D(_0041_),
    .RESET_B(net282),
 ...
 sky130_fd_sc_hd__dfrtp_2 _4864_ (.CLK(clknet_leaf_26_clk_i),
    .D(_0044_),
    .RESET_B(net283),
 ...
 sky130_fd_sc_hd__dfrtp_2 _4866_ (.CLK(clknet_leaf_26_clk_i),
    .D(_0046_),
    .RESET_B(net282),
 ...
 sky130_fd_sc_hd__dfrtp_4 _4899_ (.CLK(clknet_leaf_15_clk_i),
    .D(_0079_),
    .RESET_B(net290),
 ...
 sky130_fd_sc_hd__dfrtp_4 _4902_ (.CLK(clknet_leaf_13_clk_i),
    .D(_0082_),
    .RESET_B(net297),
 ...
 sky130_fd_sc_hd__dfrtp_4 _4941_ (.CLK(clknet_leaf_16_clk_i),
    .D(_0121_),
    .RESET_B(net292),
 ...
 sky130_fd_sc_hd__dfrtp_4 _4981_ (.CLK(clknet_leaf_24_clk_i),
    .D(_0161_),
    .RESET_B(net285),
    .Q(\i_decode_stage.decode_state_o[128] ));
 sky130_fd_sc_hd__dfrtp_2 _4982_ (.CLK(clknet_leaf_15_clk_i),
    .D(_0162_),
    .RESET_B(net289),
 ...
 sky130_fd_sc_hd__dfrtp_4 _5015_ (.CLK(clknet_leaf_26_clk_i),
    .D(_0195_),
    .RESET_B(net283),
    .Q(\i_decode_stage.decode_state_o[119] ));
 sky130_fd_sc_hd__dfrtp_4 _5016_ (.CLK(clknet_leaf_25_clk_i),
    .D(_0196_),
    .RESET_B(net283),
 ...
 sky130_fd_sc_hd__dfrtp_4 _5027_ (.CLK(clknet_leaf_11_clk_i),
 ...
 sky130_fd_sc_hd__buf_2 input51 (.A(imem_rdata_i[25]),
    .X(net51));
 sky130_fd_sc_hd__buf_2 input52 (.A(imem_rdata_i[26]),
    .X(net52));
 ...
 sky130_fd_sc_hd__clkbuf_16 fanout287 (.A(net288),
    .X(net287));
 sky130_fd_sc_hd__clkbuf_16 fanout288 (.A(net131),
    .X(net288));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold1 (.A(\i_exec_stage.reg_meta_o[4] ),
    .X(net338));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold2 (.A(\i_exec_stage.exec_state_o[35] ),
    .X(net339));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold3 (.A(\i_exec_stage.exec_state_o[16] ),
    .X(net340));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold4 (.A(\i_exec_stage.exec_state_o[19] ),
    .X(net341));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold5 (.A(\i_exec_stage.exec_state_o[27] ),
    .X(net342));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold6 (.A(\i_exec_stage.exec_state_o[23] ),
    .X(net343));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold7 (.A(\i_exec_stage.exec_state_o[21] ),
    .X(net344));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold8 (.A(\i_exec_stage.reg_meta_o[3] ),
    .X(net345));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold9 (.A(\i_exec_stage.exec_state_o[33] ),
    .X(net346));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold10 (.A(\i_exec_stage.exec_state_o[20] ),
    .X(net347));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold11 (.A(\i_exec_stage.exec_state_o[18] ),
    .X(net348));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold12 (.A(\i_exec_stage.exec_state_o[36] ),
    .X(net349));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold13 (.A(\i_exec_stage.exec_state_o[41] ),
    .X(net350));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold14 (.A(\i_exec_stage.exec_state_o[52] ),
    .X(net351));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold15 (.A(\i_exec_stage.exec_state_o[39] ),
    .X(net352));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold16 (.A(\i_decode_stage.decode_state_o[10] ),
    .X(net353));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold17 (.A(\i_decode_stage.decode_state_o[25] ),
    .X(net354));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold18 (.A(\i_exec_stage.exec_state_o[62] ),
    .X(net355));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold19 (.A(\i_exec_stage.exec_state_o[29] ),
    .X(net356));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold20 (.A(\i_exec_stage.exec_state_o[59] ),
    .X(net357));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold21 (.A(\i_exec_stage.exec_state_o[30] ),
    .X(net358));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold22 (.A(\i_exec_stage.exec_state_o[68] ),
    .X(net359));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold23 (.A(\i_exec_stage.exec_state_o[38] ),
    .X(net360));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold24 (.A(\i_exec_stage.exec_state_o[51] ),
    .X(net361));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold25 (.A(\i_exec_stage.exec_state_o[31] ),
    .X(net362));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold26 (.A(\i_exec_stage.exec_state_o[61] ),
    .X(net363));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold27 (.A(\i_exec_stage.exec_state_o[65] ),
    .X(net364));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold28 (.A(\i_exec_stage.exec_state_o[32] ),
    .X(net365));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold29 (.A(\i_exec_stage.exec_state_o[67] ),
    .X(net366));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold30 (.A(\i_exec_stage.exec_state_o[69] ),
    .X(net367));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold31 (.A(\i_exec_stage.exec_state_o[50] ),
    .X(net368));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold32 (.A(\i_exec_stage.exec_state_o[13] ),
    .X(net369));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold33 (.A(\i_exec_stage.exec_state_o[14] ),
    .X(net370));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold34 (.A(\i_exec_stage.valid_o ),
    .X(net371));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold35 (.A(\i_exec_stage.exec_state_o[22] ),
    .X(net372));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold36 (.A(\i_exec_stage.exec_state_o[9] ),
    .X(net373));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold37 (.A(\i_exec_stage.reg_meta_o[1] ),
    .X(net374));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold38 (.A(\i_exec_stage.exec_state_o[24] ),
    .X(net375));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold39 (.A(\i_exec_stage.exec_state_o[37] ),
    .X(net376));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold40 (.A(\i_exec_stage.exec_state_o[26] ),
    .X(net377));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold41 (.A(\i_exec_stage.exec_state_o[12] ),
    .X(net378));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold42 (.A(\i_exec_stage.exec_state_o[28] ),
    .X(net379));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold43 (.A(\i_exec_stage.reg_meta_o[2] ),
    .X(net380));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold44 (.A(\i_exec_stage.exec_state_o[64] ),
    .X(net381));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold45 (.A(\i_exec_stage.exec_state_o[46] ),
    .X(net382));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold46 (.A(\i_exec_stage.exec_state_o[43] ),
    .X(net383));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold47 (.A(\i_exec_stage.exec_state_o[10] ),
    .X(net384));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold48 (.A(\i_exec_stage.exec_state_o[11] ),
    .X(net385));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold49 (.A(\i_exec_stage.exec_state_o[48] ),
    .X(net386));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold50 (.A(\i_exec_stage.exec_state_o[25] ),
    .X(net387));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold51 (.A(\i_exec_stage.exec_state_o[40] ),
    .X(net388));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold52 (.A(\i_decode_stage.decode_state_o[31] ),
    .X(net389));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold53 (.A(\i_exec_stage.exec_state_o[54] ),
    .X(net390));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold54 (.A(\i_exec_stage.exec_state_o[58] ),
    .X(net391));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold55 (.A(\i_exec_stage.exec_state_o[70] ),
    .X(net392));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold56 (.A(\i_exec_stage.exec_state_o[66] ),
    .X(net393));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold57 (.A(\i_exec_stage.exec_state_o[42] ),
    .X(net394));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold58 (.A(\i_exec_stage.exec_state_o[15] ),
    .X(net395));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold59 (.A(\i_decode_stage.decode_state_o[14] ),
    .X(net396));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold60 (.A(\i_exec_stage.reg_meta_o[0] ),
    .X(net397));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold61 (.A(\i_exec_stage.exec_state_o[6] ),
    .X(net398));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold62 (.A(\i_exec_stage.exec_state_o[44] ),
    .X(net399));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold63 (.A(\i_exec_stage.exec_state_o[49] ),
    .X(net400));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold64 (.A(\i_exec_stage.exec_state_o[47] ),
    .X(net401));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold65 (.A(\i_decode_stage.decode_state_o[6] ),
    .X(net402));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold66 (.A(\i_exec_stage.exec_state_o[53] ),
    .X(net403));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold67 (.A(\i_exec_stage.exec_state_o[63] ),
    .X(net404));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold68 (.A(\i_exec_stage.exec_state_o[60] ),
    .X(net405));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold69 (.A(\i_exec_stage.exec_state_o[45] ),
    .X(net406));
 sky130_fd_sc_hd__clkdlybuf4s50_1 hold70 (.A(\i_exec_stage.exec_state_o[4] ),
    .X(net407));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold71 (.A(\i_decode_stage.decode_state_o[32] ),
    .X(net408));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold72 (.A(\i_exec_stage.exec_state_o[55] ),
    .X(net409));
 sky130_fd_sc_hd__clkdlybuf4s50_1 hold73 (.A(\i_exec_stage.exec_state_o[56] ),
    .X(net410));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold74 (.A(\i_exec_stage.exec_state_o[34] ),
    .X(net411));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold75 (.A(\i_decode_stage.decode_state_o[36] ),
    .X(net412));
 sky130_fd_sc_hd__clkdlybuf4s50_1 hold76 (.A(\i_exec_stage.exec_state_o[57] ),
    .X(net413));
 sky130_fd_sc_hd__clkdlybuf4s25_1 hold77 (.A(\i_exec_stage.exec_state_o[17] ),
    .X(net414));
 sky130_fd_sc_hd__diode_2 ANTENNA_1 (.DIODE(_0454_));
 sky130_fd_sc_hd__diode_2 ANTENNA_2 (.DIODE(_0528_));
 sky130_fd_sc_hd__diode_2 ANTENNA_3 (.DIODE(\i_decode_stage.decode_state_o[100] ));
 sky130_fd_sc_hd__diode_2 ANTENNA_4 (.DIODE(\i_decode_stage.decode_state_o[130] ));
 sky130_fd_sc_hd__diode_2 ANTENNA_5 (.DIODE(\i_mem_slice_stage.mem_state_o[96] ));
 sky130_fd_sc_hd__diode_2 ANTENNA_6 (.DIODE(net43));
 sky130_fd_sc_hd__diode_2 ANTENNA_7 (.DIODE(net46));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_13 (.DIODE(net52));
 sky130_fd_sc_hd__diode_2 ANTENNA_14 (.DIODE(net61));
 sky130_fd_sc_hd__diode_2 ANTENNA_15 (.DIODE(net62));
 sky130_fd_sc_hd__diode_2 ANTENNA_16 (.DIODE(net145));
 sky130_fd_sc_hd__diode_2 ANTENNA_17 (.DIODE(net145));
 sky130_fd_sc_hd__diode_2 ANTENNA_18 (.DIODE(net157));
 sky130_fd_sc_hd__diode_2 ANTENNA_19 (.DIODE(net184));
 sky130_fd_sc_hd__diode_2 ANTENNA_20 (.DIODE(net186));
 sky130_fd_sc_hd__diode_2 ANTENNA_21 (.DIODE(net188));
 sky130_fd_sc_hd__diode_2 ANTENNA_22 (.DIODE(net201));
 sky130_fd_sc_hd__diode_2 ANTENNA_23 (.DIODE(net202));
 sky130_fd_sc_hd__diode_2 ANTENNA_24 (.DIODE(net203));
 sky130_fd_sc_hd__diode_2 ANTENNA_25 (.DIODE(net206));
 sky130_fd_sc_hd__diode_2 ANTENNA_26 (.DIODE(net207));
 sky130_fd_sc_hd__diode_2 ANTENNA_27 (.DIODE(net211));
 sky130_fd_sc_hd__diode_2 ANTENNA_28 (.DIODE(net213));
 sky130_fd_sc_hd__diode_2 ANTENNA_29 (.DIODE(net214));
 sky130_fd_sc_hd__diode_2 ANTENNA_30 (.DIODE(net214));
 sky130_fd_sc_hd__diode_2 ANTENNA_31 (.DIODE(net219));
 sky130_fd_sc_hd__diode_2 ANTENNA_32 (.DIODE(net220));
 sky130_fd_sc_hd__diode_2 ANTENNA_33 (.DIODE(net224));
 sky130_fd_sc_hd__diode_2 ANTENNA_34 (.DIODE(net225));
 sky130_fd_sc_hd__diode_2 ANTENNA_35 (.DIODE(_0495_));
 sky130_fd_sc_hd__diode_2 ANTENNA_36 (.DIODE(_0504_));
 sky130_fd_sc_hd__diode_2 ANTENNA_37 (.DIODE(_0512_));
 sky130_fd_sc_hd__diode_2 ANTENNA_38 (.DIODE(_0565_));
 sky130_fd_sc_hd__diode_2 ANTENNA_39 (.DIODE(_1335_));
 sky130_fd_sc_hd__diode_2 ANTENNA_40 (.DIODE(\i_decode_stage.decode_state_o[46] ));
 sky130_fd_sc_hd__diode_2 ANTENNA_41 (.DIODE(net38));
 sky130_fd_sc_hd__diode_2 ANTENNA_42 (.DIODE(net46));
 sky130_fd_sc_hd__diode_2 ANTENNA_43 (.DIODE(net46));
 sky130_fd_sc_hd__diode_2 ANTENNA_44 (.DIODE(net46));
 sky130_fd_sc_hd__diode_2 ANTENNA_45 (.DIODE(net46));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_50 (.DIODE(net48));
 sky130_fd_sc_hd__diode_2 ANTENNA_51 (.DIODE(net50));
 sky130_fd_sc_hd__diode_2 ANTENNA_52 (.DIODE(net53));
 sky130_fd_sc_hd__diode_2 ANTENNA_53 (.DIODE(net57));
 sky130_fd_sc_hd__diode_2 ANTENNA_54 (.DIODE(net58));
 sky130_fd_sc_hd__diode_2 ANTENNA_55 (.DIODE(net60));
 sky130_fd_sc_hd__diode_2 ANTENNA_56 (.DIODE(net136));
 sky130_fd_sc_hd__diode_2 ANTENNA_57 (.DIODE(net136));
 sky130_fd_sc_hd__diode_2 ANTENNA_58 (.DIODE(net144));
 sky130_fd_sc_hd__diode_2 ANTENNA_59 (.DIODE(net147));
 sky130_fd_sc_hd__diode_2 ANTENNA_60 (.DIODE(net147));
 sky130_fd_sc_hd__diode_2 ANTENNA_61 (.DIODE(net147));
 sky130_fd_sc_hd__diode_2 ANTENNA_62 (.DIODE(net151));
 sky130_fd_sc_hd__diode_2 ANTENNA_63 (.DIODE(net153));
 sky130_fd_sc_hd__diode_2 ANTENNA_64 (.DIODE(net153));
 sky130_fd_sc_hd__diode_2 ANTENNA_65 (.DIODE(net153));
 sky130_fd_sc_hd__diode_2 ANTENNA_66 (.DIODE(net153));
 sky130_fd_sc_hd__diode_2 ANTENNA_67 (.DIODE(net156));
 sky130_fd_sc_hd__diode_2 ANTENNA_68 (.DIODE(net199));
 sky130_fd_sc_hd__diode_2 ANTENNA_69 (.DIODE(net205));
 sky130_fd_sc_hd__diode_2 ANTENNA_70 (.DIODE(net205));
 sky130_fd_sc_hd__diode_2 ANTENNA_71 (.DIODE(net205));
 sky130_fd_sc_hd__diode_2 ANTENNA_72 (.DIODE(net215));
 sky130_fd_sc_hd__diode_2 ANTENNA_73 (.DIODE(net217));
 sky130_fd_sc_hd__diode_2 ANTENNA_74 (.DIODE(net219));
 sky130_fd_sc_hd__diode_2 ANTENNA_75 (.DIODE(net221));
 sky130_fd_sc_hd__diode_2 ANTENNA_76 (.DIODE(net222));
 sky130_fd_sc_hd__diode_2 ANTENNA_77 (.DIODE(net226));
 sky130_fd_sc_hd__diode_2 ANTENNA_78 (.DIODE(net227));
 sky130_fd_sc_hd__diode_2 ANTENNA_79 (.DIODE(net228));
 sky130_fd_sc_hd__diode_2 ANTENNA_80 (.DIODE(net231));
 sky130_fd_sc_hd__diode_2 ANTENNA_81 (.DIODE(net231));
 sky130_fd_sc_hd__diode_2 ANTENNA_82 (.DIODE(net246));
 sky130_fd_sc_hd__diode_2 ANTENNA_83 (.DIODE(\i_exec_stage.alu_out[1] ));
 sky130_fd_sc_hd__diode_2 ANTENNA_84 (.DIODE(net48));
 sky130_fd_sc_hd__diode_2 ANTENNA_85 (.DIODE(net48));
 sky130_fd_sc_hd__diode_2 ANTENNA_86 (.DIODE(net48));
 sky130_fd_sc_hd__diode_2 ANTENNA_87 (.DIODE(net48));
 sky130_fd_sc_hd__diode_2 ANTENNA_88 (.DIODE(net48));
 sky130_fd_sc_hd__diode_2 ANTENNA_89 (.DIODE(net48));
 sky130_fd_sc_hd__diode_2 ANTENNA_90 (.DIODE(net48));
 sky130_fd_sc_hd__diode_2 ANTENNA_91 (.DIODE(net48));
 sky130_fd_sc_hd__diode_2 ANTENNA_92 (.DIODE(net49));
 sky130_fd_sc_hd__diode_2 ANTENNA_93 (.DIODE(net49));
 sky130_fd_sc_hd__diode_2 ANTENNA_94 (.DIODE(net49));
 sky130_fd_sc_hd__diode_2 ANTENNA_95 (.DIODE(net49));
 sky130_fd_sc_hd__diode_2 ANTENNA_96 (.DIODE(net49));
 sky130_fd_sc_hd__diode_2 ANTENNA_97 (.DIODE(net49));
 sky130_fd_sc_hd__diode_2 ANTENNA_98 (.DIODE(net50));
 sky130_fd_sc_hd__diode_2 ANTENNA_99 (.DIODE(net50));
 sky130_fd_sc_hd__diode_2 ANTENNA_100 (.DIODE(net50));
 sky130_fd_sc_hd__diode_2 ANTENNA_101 (.DIODE(net50));
 sky130_fd_sc_hd__diode_2 ANTENNA_102 (.DIODE(net50));
 sky130_fd_sc_hd__diode_2 ANTENNA_103 (.DIODE(net50));
 sky130_fd_sc_hd__diode_2 ANTENNA_104 (.DIODE(net60));
 sky130_fd_sc_hd__diode_2 ANTENNA_105 (.DIODE(net231));
 sky130_fd_sc_hd__diode_2 ANTENNA_106 (.DIODE(net49));
 sky130_fd_sc_hd__diode_2 ANTENNA_107 (.DIODE(net49));
 sky130_fd_sc_hd__diode_2 ANTENNA_108 (.DIODE(net49));
 sky130_fd_sc_hd__diode_2 ANTENNA_109 (.DIODE(net49));
 sky130_fd_sc_hd__diode_2 ANTENNA_110 (.DIODE(net49));
 sky130_fd_sc_hd__diode_2 ANTENNA_111 (.DIODE(net49));
 sky130_fd_sc_hd__diode_2 ANTENNA_112 (.DIODE(net49));
 sky130_fd_sc_hd__diode_2 ANTENNA_113 (.DIODE(net49));
 sky130_fd_sc_hd__diode_2 ANTENNA_114 (.DIODE(net49));
